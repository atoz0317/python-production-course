...
function generate-project {
    ...
    git add --all
    git branch -M main
    git commit -m "feat: generate sample project with python-production-course"
...
EOF
    ...
    gh pr create \
        --title "feat: populate from \`python-production-course\` template" \
        --body "This PR was generated by \`python-production-course\`" \
        --base main \
